<template>
  <div class="hello">
    ...
    <p>
      ...
      <a href="https://phototrend.fr/2015/03/mp-130-realiser-un-projet-photo-52/" target="_blank" rel="noopener">sur phototrend</a>.
    </p>
    ...
    <p>
      Si vous publier vos photos merci d'utiliser le tag #tdt{{year}}p52
    </p>
    <h3>Liens utile</h3>
    <ul>
    ...
    <ul>
      ...
      <li><a href="http://www.tisseurdetoile.net" target="_blank" rel="noopener">(c) Le TisseurDeToile</a></li>
    </ul>
  </div>
</template>
